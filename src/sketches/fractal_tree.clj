;; fractal tree algo taken from x.com/i/status/2057186570210275383
(ns sketches.fractal-tree
    ...
    (if (> len 2)
      (do
        ...
        (if sym? (q/rotate (/ q/PI 6))    ;symetrical
          ;; 0.55 controls how much randomnes in the angle in both sides
...
(defn fractal-tree [ini-len symetrical?]
  (q/sketch
    :size [800 800]
    :settings #(q/smooth 16)
    :setup setup
    :draw #(draw ini-len symetrical?)))

(comment 
  (fractal-tree 150 false)
  #_(quil.applet/with-applet sketch
