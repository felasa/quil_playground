(ns sketches.windlike
  (:require [quil.core :as q]
            [util.fields :refer [perlin-noise3 perlin-field3]]
            [clojure.java.shell :refer [sh]]))

;; TODO: refactor drawing fun
;; TODO: refactor perlin funs
;(def combos ((json/read-str (slurp "resources/sanzo-colors.json")) "combos"))
(def combos (into [] ((read-string (slurp "resources/sanzo-colors.edn")) :combos)))
...
(q/defsketch wind
  ...
  ;not working
  ;:on-close 
  #_(clojure.java.shell/sh "ffmpeg" 
      "-framerate" "10" 
