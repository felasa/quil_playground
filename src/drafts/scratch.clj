...
(def palette
  (->> (read-string (slurp "resources/sanzo-colors.edn"))
       :combos
       ;(take 10)))
       (filter #(= (:id_combo %) 344))
       first
    ...
    (fn []
      ...
      (dotimes [_ 1000]
        (let [p-ini [(rand-int 800) (rand-int 800)]
              crv (fields/field-curve simplex-field 3 10 p-ini)]
